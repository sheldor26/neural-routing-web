    ...
    <div className="min-h-screen bg-[#050505] text-zinc-300 font-sans selection:bg-blue-500/30 overflow-x-hidden relative">
      ...
      <nav className="border-b border-white/5 bg-black/40 backdrop-blur-xl sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between text-white">
          ...
          <div className="flex items-center gap-6">
            <Link href="/" className="flex items-center gap-2 text-[10px] font-black uppercase tracking-widest text-zinc-500 hover:text-white transition-all">
              <Home size={14} /> Home
            </Link>
      ...
      <main className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          ...
          <div className="p-8 rounded-[2.5rem] bg-zinc-900/20 border border-zinc-800">
            <p className="text-[10px] font-black uppercase tracking-[0.3em] text-zinc-500 mb-2">Quality Index</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-12">
          ...
          <div className="lg:col-span-7 p-10 rounded-[3rem] bg-zinc-900/10 border border-zinc-800 shadow-2xl overflow-hidden">
            ...
            <div className="space-y-4">
              {decisions.length > 0 ? decisions.map((dec: any, i) => {
                ...
                <p className="text-[10px] text-zinc-600 italic uppercase">Awaiting incoming neural telemetry...</p>
              )}
            </div>
          </div>
          ...
          <div className="lg:col-span-5 p-10 rounded-[3rem] bg-blue-600/5 border border-blue-500/20 relative overflow-hidden group shadow-2xl">
            <div className="relative z-10">
              ...
              <button className="w-full mt-6 py-5 bg-blue-600 text-white rounded-2xl font-black uppercase text-[10px] tracking-widest hover:bg-blue-500 transition-all active:scale-95 shadow-lg shadow-blue-500/20">
        ...
        <div className="p-10 rounded-[3rem] bg-zinc-900/10 border border-zinc-800 flex flex-col h-[480px] shadow-2xl mb-12">
          <h4 className="text-white font-black italic uppercase tracking-tighter text-2xl flex items-center gap-3 mb-10">
            <TrendingUp size={24} className="text-blue-500" /> Optimization History
          </h4>
