...
export const metadata: Metadata = {
  ...
  description: "Route every AI request to the cheapest capable model. NeuralRouting cuts LLM costs up to 85% with intelligent routing, semantic caching, and failover. OpenAI SDK compatible.",
